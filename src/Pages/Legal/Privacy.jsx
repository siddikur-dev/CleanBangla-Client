...
const Privacy = () => {
  return (
    <div className="bg-base-200 min-h-screen py-16">
      <title>Privacy - CleanBangla</title>
      <div className="container mx-auto px-4">
        <SectionHeader
          title={"Privacy Policy"}
          description={
            "Your privacy matters. This policy explains how CleanBangla collects, uses, and protects your information."
          }
          ...
          <section>
            ...
            <p className="text-base-content/70 leading-relaxed">
              ...
              <a
                ...
                href="mailto:privacy@cleanbangla.org"
              >
                privacy@cleanbangla.org
              </a>
              .
            </p>
          </section>
